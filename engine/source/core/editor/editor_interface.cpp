...
namespace Forge {
	...
	//	io.ConfigViewportsNoAutoMerge = true;
		...
		io.FontDefault = io.Fonts->AddFontFromFileTTF("assets/fonts/kanit/Kanit-Medium.ttf", 20);
	...
	void UI_Layer::SetDarkThemeColors()
	{
		auto& colors = ImGui::GetStyle().Colors;
		colors[ImGuiCol_WindowBg] = ImVec4{ 0.14f, 0.12f, 0.123f, 1.0f };
